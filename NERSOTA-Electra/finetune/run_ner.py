...
def evaluate(args, model, eval_dataset, mode, global_step=None):
    ...
    # output_pred_file = os.path.join(output_dir, "{}-{}.txt".format(mode, global_step) if global_step else "{}.txt".format(mode))
    # with open(output_pred_file, "w") as file:
    #     logger.info("***** Pred results on {} dataset *****".format(mode))
    #     for 
